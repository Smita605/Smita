...
const app = express();
const PORT = 5000;
const SECRET_KEY = "process.env"; // Use process.env in production
...
// ✅ Connect MongoDB
mongoose
  .connect("mongodb://localhost:27017/colsocial")
...
app.post("/events", authMiddleware, async (req, res) => {
  ...
  // take first word of email before "@"
...
// Get all forums
app.get("/forums", authMiddleware, async (req, res) => {
  try {
...
// Add forum
app.post("/forums/:id/replies", authMiddleware, async (req, res) => {
  const { text } = req.body;
